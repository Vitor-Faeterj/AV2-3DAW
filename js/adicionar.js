function cadastrar(){
	...
	let url = "http://localhost/lojaXimbole/adicionarProd.php?codProd="+codProd+"&nomeProd="+nomeProd+
	"&fabricante="+fabricanteProd+"&categoriaProd="+categoria+"&tipoProd="+tipoProd+"&precoProd="+precoProd+
	"&qtdEstoque="+qtdEstoque+"&pesoProd="+pesoProd+"&dataInclusao="+dataInclusao;
